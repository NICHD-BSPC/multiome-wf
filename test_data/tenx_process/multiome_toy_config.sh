...
ATAC_PEAKS="$TOY_IN/atac_peaks.bed"
TOY_PEAKS_BED="$TOY_OUT/toy_peaks.bed"
TOY_PEAKS_PEAKS="$TOY_OUT/toy_peaks_peaks.tsv"
TOYGEX_BARCODES="$TOY_OUT/toygex_barcodes.txt"
BARCODE_NTH=5
ATAC_NTH=6
PEAK_NTH=6
