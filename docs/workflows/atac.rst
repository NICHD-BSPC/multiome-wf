...
The scATAC-Seq workflow starts with aligned reads in BAM files and feature-by-barcode matrices and performs various QC steps and batch correction, clustering optimization, differential testing, and combines
everything together into a single Seurat object for easy exploratory visualization and downstream analysis.
...
Specifically, the workflow does the following:
    ...
    - Reduces technical variation and batch effeects.
